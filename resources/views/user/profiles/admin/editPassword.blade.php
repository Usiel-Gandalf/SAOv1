            ...
            <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded border-primary">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('editAdminPassword')}}" tabindex="-1" aria-disabled="true">CAMBIAR CONTRASEÑA</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-body">
                    <h4 class="card-title">ACTUALIZAR PASSWORD</h4>
                    <div class="container border-danger">
                        <form action="{{url('/editAdminPassword/'.$idAdmin.'/updateAdminPassword')}}" method="post" enctype="multipart/form-data" class="">
                            @csrf
                            <div class="row">
                                <div class="col">
